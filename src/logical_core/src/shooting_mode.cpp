...
//    if(logical_core_->distance(logical_core_->enemy_global_goal_, logical_core_->old_enemy_global_goal_) > 3.0)
//    {
//        logical_core_->p_mission_mode_ = logical_core_->p_shooting_mode_;
